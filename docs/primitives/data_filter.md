...
| operator | string | **Oui** | — | OpÃ©rateur de comparaison logique. (equals, not_equals, contains, not_contains, starts_with, ends_with, regex, greater_than, greater_or_equal, less_than, less_or_equal, is_null, is_not_null, in, not_in) |
